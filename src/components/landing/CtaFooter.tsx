    ...
    <section className="relative overflow-hidden bg-background py-24 md:py-32">
      <div className="container-narrow">
        <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <Link
            to="/pedido"
            className="group mt-10 inline-flex items-center gap-3 rounded-2xl bg-burgundy px-10 py-5 text-xs uppercase tracking-[0.3em] text-cream shadow-soft transition-all duration-500 hover:-translate-y-0.5 hover:bg-burgundy-deep hover:shadow-elegant"
          >
        ...
        <div className="mx-auto mt-20 grid max-w-3xl gap-5 sm:grid-cols-2">
          <a
            href="https://wa.me/5534984415936"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-5 rounded-2xl border border-burgundy/15 bg-cream/60 px-6 py-6 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-burgundy/40 hover:bg-cream hover:shadow-elegant"
          >
            <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white transition-transform duration-300 group-hover:scale-110">
            ...
            <div className="flex-1 text-left">
              <p className="text-[0.65rem] uppercase tracking-[0.28em] text-petrol/60">
                Atendimento via WhatsApp
              </p>
              <p className="mt-1 font-serif text-xl text-burgundy">(34) 98441-5936</p>
              <p className="mt-1 text-xs text-petrol/60">Resposta rápida — seg a sáb</p>
            </div>
          </a>
          ...
          <a
            ...
            className="group flex items-center gap-5 rounded-2xl border border-burgundy/15 bg-cream/60 px-6 py-6 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-burgundy/40 hover:bg-cream hover:shadow-elegant"
          >
            <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-gradient-to-tr from-[#feda75] via-[#d62976] to-[#4f5bd5] text-white transition-transform duration-300 group-hover:scale-110">
              <Instagram className="h-7 w-7" />
            </span>
            <div className="flex-1 text-left">
              <p className="text-[0.65rem] uppercase tracking-[0.28em] text-petrol/60">Instagram</p>
              <p className="mt-1 font-serif text-xl text-burgundy">@sarahfrancodoces</p>
              <p className="mt-1 text-xs text-petrol/60">Bastidores e novidades</p>
            </div>
          </a>
        </div>

        {/* Localização */}
        <div className="mt-8 flex items-center justify-center gap-2 text-xs uppercase tracking-[0.28em] text-petrol/60">
